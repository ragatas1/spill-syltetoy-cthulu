...
public class fatherScript : MonoBehaviour
{
    ...
    void endreAnsikt()
    {
        if (dialogScript.index == 1) { portraitA.SetInteger("hvilketAnsikt", 50); }
        if (dialogScript.index == 2) { portraitA.SetInteger("hvilketAnsikt", 1); }
        if (dialogScript.index == 3) { portraitA.SetInteger("hvilketAnsikt", 50); }
        if (dialogScript.index == 4) { portraitA.SetInteger("hvilketAnsikt", 52); }
        if (dialogScript.index == 5) { portraitA.SetInteger("hvilketAnsikt", 1); }
